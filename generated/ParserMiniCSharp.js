...
var literalNames = [ null, "'char'", "'int'", "'float'", "'bool'", "'string'", 
                     ...
                     null, null, null, null, null, null, "'\u00C2\u00A1'", 
                     "'!'", "'\"'", "'#'", "'$'", "'&'", "'''", null, null, 
                     "']'", "'['", "'}'", "'{'", "','", "'.'", null, "':'", 
                     "';'", "'?'", "'@'", "'_'", "'+'", "'-'", "'*'", null, 
                     "'%'", "'=='", "'!='", "'>'", "'>='", "'<'", "'<='", 
...
var symbolicNames = [ null, "CHAR", "INT", "FLOAT", "BOOL", "STRING", "BREAK", 
                      ...
                      "FALSE", "IDENT", "NUMBER", "CHAR_CONST", "PRINTABLE_CHAR", 
                      "LETTER", "DIGIT", "EXCLAMATION_UP", "EXCLAMATION_DOWN", 
                      ...
                      "MINUS_MINUS", "LINE_COMMENT", "SPECIAL_COMMENT", 
                      "WS", "Number", "CharConst" ];
...
ParserMiniCSharp.IDENT = 21;
ParserMiniCSharp.NUMBER = 22;
ParserMiniCSharp.CHAR_CONST = 23;
ParserMiniCSharp.PRINTABLE_CHAR = 24;
ParserMiniCSharp.LETTER = 25;
ParserMiniCSharp.DIGIT = 26;
...
ParserMiniCSharp.RIGHT_PARENTHESIS = 34;
ParserMiniCSharp.LEFT_PARENTHESIS = 35;
ParserMiniCSharp.RIGHT_SQUARE_BRACKETR = 36;
ParserMiniCSharp.LEFT_SQUARE_BRACKET = 37;
ParserMiniCSharp.RIGHT_CURLY_BRACKET = 38;
ParserMiniCSharp.LEFT_CURLY_BRACKET = 39;
ParserMiniCSharp.COMMA = 40;
ParserMiniCSharp.DOT = 41;
ParserMiniCSharp.FORWARD_SLASH = 42;
ParserMiniCSharp.COLON = 43;
ParserMiniCSharp.SEMICOLON = 44;
ParserMiniCSharp.QUESTION_SIGN = 45;
ParserMiniCSharp.AT = 46;
ParserMiniCSharp.UNDERSCORE = 47;
ParserMiniCSharp.SUM = 48;
ParserMiniCSharp.SUBTRACTION = 49;
ParserMiniCSharp.MULTIPLICATION = 50;
ParserMiniCSharp.DIVISION = 51;
ParserMiniCSharp.PERCENTAGE = 52;
ParserMiniCSharp.EQUAL_EQUAL = 53;
ParserMiniCSharp.INEQUALITY = 54;
ParserMiniCSharp.GREATER_THAN = 55;
ParserMiniCSharp.GREATER_THAN_OR_EQUAL = 56;
ParserMiniCSharp.LESS_THAN = 57;
ParserMiniCSharp.LESS_THAN_OR_EQUAL = 58;
ParserMiniCSharp.AND = 59;
ParserMiniCSharp.OR = 60;
ParserMiniCSharp.EQUAL = 61;
ParserMiniCSharp.PLUS_PLUS = 62;
ParserMiniCSharp.MINUS_MINUS = 63;
...
ParserMiniCSharp.prototype.program = function() {
    ...
    try {
        ...
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ParserMiniCSharp.CLASS) | (1 << ParserMiniCSharp.CONST) | (1 << ParserMiniCSharp.IDENT))) !== 0)) {
            this.state = 45;
            this._errHandler.sync(this);
...
ParserMiniCSharp.prototype.block = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << ParserMiniCSharp.BREAK) | (1 << ParserMiniCSharp.IF) | (1 << ParserMiniCSharp.READ) | (1 << ParserMiniCSharp.RETURN) | (1 << ParserMiniCSharp.WHILE) | (1 << ParserMiniCSharp.WRITE) | (1 << ParserMiniCSharp.FOREACH) | (1 << ParserMiniCSharp.FOR) | (1 << ParserMiniCSharp.IDENT))) !== 0) || _la===ParserMiniCSharp.LEFT_CURLY_BRACKET || _la===ParserMiniCSharp.SEMICOLON) {
            this.state = 162;
            this.statement();
            this.state = 167;
            this._errHandler.sync(this);
...
ParserMiniCSharp.prototype.relop = function() {
    ...
    try {
        ...
        this.state = 236;
        _la = this._input.LA(1);
        if(!(((((_la - 53)) & ~0x1f) == 0 && ((1 << (_la - 53)) & ((1 << (ParserMiniCSharp.EQUAL_EQUAL - 53)) | (1 << (ParserMiniCSharp.INEQUALITY - 53)) | (1 << (ParserMiniCSharp.GREATER_THAN - 53)) | (1 << (ParserMiniCSharp.GREATER_THAN_OR_EQUAL - 53)) | (1 << (ParserMiniCSharp.LESS_THAN - 53)) | (1 << (ParserMiniCSharp.LESS_THAN_OR_EQUAL - 53)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
...
ParserMiniCSharp.prototype.mulop = function() {
    ...
    try {
        ...
        this.state = 240;
        _la = this._input.LA(1);
        if(!(((((_la - 50)) & ~0x1f) == 0 && ((1 << (_la - 50)) & ((1 << (ParserMiniCSharp.MULTIPLICATION - 50)) | (1 << (ParserMiniCSharp.DIVISION - 50)) | (1 << (ParserMiniCSharp.PERCENTAGE - 50)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
